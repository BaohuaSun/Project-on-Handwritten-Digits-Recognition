function [PosHandWritten imData DataGroundTruth]=fun_ReadOriginalData(FileName)
...
if FileName(1:5)=='Train'
    save('TrainDataMatFile', 'PosHandWritten', 'imData', 'DataGroundTruth')
else
    save('TestDataMatFile', 'PosHandWritten', 'imData', 'DataGroundTruth')
end
